...
MODEL_DIR = "experiments/t5_small_optimized"  # Change this to your trained model directory
...
def evaluate():
    ...
    eval_args = Seq2SeqTrainingArguments(
        output_dir="temp_eval_t5_small",
        per_device_eval_batch_size=8,   # Safe for MPS
